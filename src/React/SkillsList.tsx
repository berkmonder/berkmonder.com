...
const SkillsList = () => {
  ...
  const skills: Record<string, string[]> = {
    "MLOps & Infrastructure": [
      "Scalable AI/ML Pipeline Deployment",
      "Model Serving & Cloud Architecture",
      "Docker, Containerization & CI/CD",
    ],
    "AI / ML Systems": [
      "Turquoise Model Marketplace",
      "Multi-tenant LLM & ML Integrations",
      "Model Monitoring & Performance Tuning",
    ],
    "Physics & Analytics": [
      "Master's in Physics (İstanbul Univ.)",
