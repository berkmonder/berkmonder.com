---
title: Turquoise - AI/ML Model Marketplace
date: 2026-08-30
description: A high-performance, multi-tenant AI/ML model marketplace built for scaling AI workflows.
image: ../assets/spectre.png
info:
  - text: Website
    link: https://turquoise.berkmonder.com
    icon:
      type: lucide
      name: globe
  - text: GitHub
    link: https://github.com/berkmonder
    icon:
      type: lucide
      name: github
---
