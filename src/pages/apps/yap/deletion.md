...
Because YAP is completely localized and does not use any cloud servers, we do not hold any of your data. 

## How to delete your data

To permanently delete all data associated with YAP:
